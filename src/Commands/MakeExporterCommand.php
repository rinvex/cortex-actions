...
use Cortex\Actions\Commands\FileGenerators\ExporterClassGenerator;

use function Laravel\Prompts\confirm;
use function Laravel\Prompts\suggest;

#[AsCommand(name: 'make:cortex-exporter', aliases: [
    'cortex:exporter',
])]
class MakeExporterCommand extends Command
{
    ...
    protected $description = 'Create a new Cortex exporter class';

    protected $name = 'make:cortex-exporter';
