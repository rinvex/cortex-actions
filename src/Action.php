...
use Cortex\Support\Exceptions\Halt;
use Illuminate\Contracts\View\View;
use Cortex\Support\Concerns\HasIcon;
use Cortex\Actions\Concerns\HasForm;
use Cortex\Actions\Concerns\HasName;
use Cortex\Actions\Concerns\HasSize;
use Cortex\Support\Concerns\HasBadge;
use Cortex\Support\Concerns\HasColor;
use Cortex\Support\Exceptions\Cancel;
use Cortex\Actions\Concerns\CanClose;
use Cortex\Actions\Concerns\HasLabel;
use Cortex\Actions\Concerns\CanNotify;
use Cortex\Actions\Concerns\HasAction;
use Cortex\Actions\Concerns\HasSchema;
use Cortex\Actions\Concerns\HasWizard;
use Cortex\Actions\Concerns\HasTooltip;
use Illuminate\Database\Eloquent\Model;
use Cortex\Actions\Concerns\CanOpenUrl;
use Cortex\Actions\Concerns\CanBeHidden;
use Cortex\Actions\Concerns\CanBeSorted;
use Cortex\Actions\Concerns\CanRedirect;
use Cortex\Actions\Concerns\HasInfolist;
use Cortex\Actions\Concerns\CanBeMounted;
use Cortex\Actions\Concerns\CanOpenModal;
use Cortex\Actions\Concerns\HasArguments;
use Cortex\Actions\Concerns\HasTableIcon;
use Illuminate\Contracts\Support\Htmlable;
use Illuminate\View\ComponentAttributeBag;
use Cortex\Actions\Concerns\CanBeDisabled;
use Cortex\Actions\Concerns\CanBeOutlined;
use Cortex\Actions\Concerns\CanSubmitForm;
use Illuminate\Contracts\Support\Arrayable;
use Cortex\Actions\Concerns\BelongsToGroup;
use Cortex\Actions\Concerns\BelongsToTable;
use Cortex\Actions\Concerns\HasGroupedIcon;
use Cortex\Actions\Concerns\HasKeyBindings;
use Cortex\Support\Components\ViewComponent;
use Cortex\Actions\Concerns\CanBeAuthorized;
use Cortex\Actions\Concerns\CanBeLabeledFrom;
use Cortex\Actions\Concerns\CanBeRateLimited;
use Cortex\Actions\Concerns\CanDispatchEvent;
use Cortex\Actions\Concerns\HasParentActions;
use Cortex\Actions\Concerns\BelongsToLivewire;
use Cortex\Actions\Concerns\HasLifecycleHooks;
use Cortex\Support\Concerns\HasExtraAttributes;
use Cortex\Actions\Concerns\CanCallParentAction;
use Cortex\Actions\Concerns\InteractsWithRecord;
use Cortex\Actions\Concerns\HasMountableArguments;
use Cortex\Actions\Concerns\CanRequireConfirmation;
use Cortex\Actions\Concerns\CanFetchSelectedRecords;
use Cortex\Actions\Concerns\BelongsToSchemaComponent;
use Cortex\Actions\Concerns\CanAccessSelectedRecords;
use Cortex\Support\View\Concerns\CanGenerateLinkHtml;
use Cortex\Support\View\Concerns\CanGenerateBadgeHtml;
use Cortex\Support\View\Concerns\CanGenerateButtonHtml;
use Cortex\Actions\Concerns\CanUseDatabaseTransactions;
use Cortex\Actions\Concerns\HasExtraModalWindowAttributes;
use Cortex\Support\View\Concerns\CanGenerateIconButtonHtml;
use Cortex\Support\View\Concerns\CanGenerateDropdownItemHtml;
use Cortex\Actions\Concerns\CanDeselectRecordsAfterCompletion;
...
class Action extends ViewComponent implements Arrayable
{
    ...
    use CanBeSorted;
    use CanCallParentAction;
    use CanClose;
    use CanDeselectRecordsAfterCompletion;
    use CanDispatchEvent;
    use CanFetchSelectedRecords;
    use CanNotify;
    use CanOpenModal;
    use CanOpenUrl;
    use CanRedirect;
    ...
    use HasAction;
    use HasArguments;
    use HasExtraModalWindowAttributes;
    use HasForm;
    use HasGroupedIcon;
    use HasInfolist;
    use HasKeyBindings;
    ...
    public const BADGE_VIEW = 'cortex.support::components.badge';

    public const BUTTON_VIEW = 'cortex.support::components.button.index';

    public const GROUPED_VIEW = 'cortex.support::components.dropdown.list.item';

    public const ICON_BUTTON_VIEW = 'cortex.support::components.icon-button';

    public const LINK_VIEW = 'cortex.support::components.link';
    ...
    {
        return Str::startsWith($view, 'cortex.support::');
    }
    ...
    {
        return view('cortex.actions::action-modal', [
            'action' => $this,
        ]);
    }
    ...
    protected function toIconButtonHtml(): string
    {
        ...
        return $this->generateIconButtonHtml(
            ...
            badge: (string) $this->getBadge(), // @FIX: string casting!
            badgeColor: $this->getBadgeColor(),
            color: $this->getColor(),
            form: $this->getFormToSubmit(),
            formId: $this->getFormId(),
