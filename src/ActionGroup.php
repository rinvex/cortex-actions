...
use Cortex\Support\Concerns\HasTooltip;
use Illuminate\Database\Eloquent\Model;
use Cortex\Actions\Concerns\CanBeHidden;
use Cortex\Actions\Concerns\HasDropdown;
...
class ActionGroup extends ViewComponent implements Arrayable, HasEmbeddedView
{
    ...
    {
        $label = $this->evaluate($this->label) ?? __('cortex.actions::group.trigger.label');
    ...
    {
        return $this->getBaseIcon() ?? CortexIcon::resolve('actions::action-group') ?? Heroicon::EllipsisVertical;
    }
    ...
    public function toEmbeddedHtml(): string
    {
        ...
        <div x-data="cortexDropdown" class="fi-dropdown">
            <div
                x-on:click="toggle"
