...
namespace Cortex\Actions\Imports\Http\Controllers;
...
use Cortex\Actions\Imports\Models\FailedImportRow;
...
class DownloadImportFailureCsv
{
    public function __invoke(Request $request, Import $import): StreamedResponse
    {
        ...
        $columnHeaders[] = __('cortex.actions::import.failure_csv.error_header');
        ...
        $import->failedRows()
            ...
            ->each(fn (FailedImportRow $failedImportRow) => $csv->insertOne([/** @phpstan-ignore argument.type */
                ...
                'error' => $failedImportRow->validation_error ?? __('cortex.actions::import.failure_csv.system_error'),
            ]));
        ...
        }, __('cortex.actions::import.failure_csv.file_name', [
