...
namespace Cortex\Actions\Imports;
...
abstract class Importer
{
    ...
    public function checkColumnMappingRequirementsForNewRecords(): void
    {
        foreach ($this->getCachedColumns() as $column) {
            ...
            Validator::validate(
                ...
                messages: ["{$columnName}.required" => __('cortex.actions::import.failure_csv.column_mapping_required_for_new_record')],
    ...
    {
        return __('cortex.actions::import.notifications.completed.title');
    }
