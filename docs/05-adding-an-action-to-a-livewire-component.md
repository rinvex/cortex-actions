...
You may [group actions together into a dropdown menu](grouping-actions) by using the `<x-cortex.actions::group>` Blade component, passing in the `actions` array as an attribute:
