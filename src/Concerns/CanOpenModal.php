...
trait CanOpenModal
{
    ...
    public function getModalSubmitActionLabel(): string
    {
        ...
        if ($this->isConfirmationRequired()) {
            return __('cortex.actions::modal.actions.confirm.label');
        }

        return __('cortex.actions::modal.actions.submit.label');
    }

    public function getModalCancelActionLabel(): string
    {
        return $this->evaluate($this->modalCancelActionLabel) ?? __('cortex.actions::modal.actions.cancel.label');
    }
    ...
    public function getModalDescription(): string | Htmlable | null
    {
        ...
        if ($this->isConfirmationRequired()) {
            return __('cortex.actions::modal.confirmation');
        }
    ...
    public function getModalIcon(): string | BackedEnum | null
    {
        ...
        if ($this->isConfirmationRequired()) {
            return CortexIcon::resolve('actions::modal.confirmation') ?? Heroicon::OutlinedExclamationTriangle;
        }
