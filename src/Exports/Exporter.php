...
namespace Cortex\Actions\Exports;
...
abstract class Exporter
{
    ...
    {
        return __('cortex.actions::export.notifications.completed.title');
    }
    ...
    {
        $disk = config('cortex.support.default_filesystem_disk');
    ...
    {
        return __('cortex.actions::export.file_name', [
