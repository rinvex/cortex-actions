...
namespace Cortex\Actions\Commands;
...
use Cortex\Support\Commands\Concerns\CanAskForComponentLocation;
use Cortex\Actions\Commands\FileGenerators\ImporterClassGenerator;
...
#[AsCommand(name: 'make:cortex-importer', aliases: [
    'cortex:importer',
])]
class MakeImporterCommand extends Command
{
    ...
    protected $description = 'Create a new Cortex importer class';

    protected $name = 'make:cortex-importer';
    ...
    protected function getOptions(): array
    {
        return [
            ...
            new InputOption(
                ...
                description: 'The namespace of the model class, [Cortex\\Custom\\Models] by default',
            ),
            new InputOption(
                name: 'force',
                shortcut: 'F',
    ...
    protected function configureModel(): void
    {
        if ($this->argument('model')) {
            ...
            $modelNamespace = $this->option('model-namespace') ?? 'Cortex\\Custom\\Models';
            ...
            $this->modelFqn = suggest(
                ...
                placeholder: 'Cortex\\Custom\\Models\\BlogPost',
                required: true,
            );
